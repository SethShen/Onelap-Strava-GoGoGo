...
class SyncEngine {
  ...
  Future<SyncSummary> runOnce({int lookbackDays = 3}) async {
    ...
    for (final item in activities) {
      ...
      final dedupeKey =
          '${item.startTime}_${distKm != null ? distKm.toStringAsFixed(2) : 'na'}_${timeSec ?? 'na'}';
          ...
          if ((!uploadToStrava || skipStrava) &&
            ...
            syncRecords.add(
              SyncRecord(
                ...
                distanceM: item.distanceKm != null
